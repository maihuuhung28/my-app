export type LineType = "MSL" | "CSL" | "Manual" | "Manual+Conv";
...
export interface GanttTask {
  ...
  isHighlighted?: boolean; // Gợi ý ưu tiên (vàng nhạt)
  isOverdue?: boolean;     // Vượt QVT date (đỏ)
}
...
export const sewingLines: SewingLine[] = [
  { id: "EE01", priLine: 1, lineType: "MSL",         productType: "JACKET (DOWN)",              avgEff: 0.538 },
  { id: "EE02", priLine: 2, lineType: "CSL",         productType: "JACKET (MIDWEIGHT)",         avgEff: 0.499 },
  { id: "EE03", priLine: 3, lineType: "Manual",      productType: "JACKET (FILLED HEAVYWEIGHT)",avgEff: 0.481 },
  { id: "EE04", priLine: 4, lineType: "Manual",      productType: "JACKET (FILLED THIN)",       avgEff: 0.427 },
  { id: "EE05", priLine: 5, lineType: "Manual+Conv", productType: "VEST (FILLED)",              avgEff: 0.488 },
  { id: "C01",  priLine: 6, lineType: "Manual",      productType: "JACKET (DOWN)",              avgEff: 0.372 },
  { id: "C02",  priLine: 7, lineType: "Manual",      productType: "JACKET",                     avgEff: 0.371 },
  { id: "C03",  priLine: 8, lineType: "Manual",      productType: "PANTS (1/1)",                avgEff: 0.409 },
  { id: "E01",  priLine: 9, lineType: "Manual",      productType: "JACKET (FILLED HEAVYWEIGHT)",avgEff: 0.480 },
  { id: "E02",  priLine:10, lineType: "Manual",      productType: "JACKET (MIDWEIGHT)",         avgEff: 0.453 },
];

// ─── Gantt tasks (kế hoạch từng chuyền) ─────────────────────
export const ganttTasks: GanttTask[] = [
  ...
  //EE02
  {
    ...
    season: "AW26", orderQty: 3600, dutyQty: 1800, target: 290,
  ...
  {
    id: 202, lineId: "EE02",
    title: "F2606LHBM418M – AW26 / OSLO / DUP",
    style: "F2606LHBM418M", buy: "OSLO", category: "DUP",
    season: "AW26", orderQty: 5000, dutyQty: 2000, target: 300,
    productionDays: 7, conversionTime: "Conv",
    inlineDate:      "2026-05-19",
    estOfflineDate:  "2026-05-29",
    finalOfflineDate:"2026-05-29",
    crd: "2026-05-28",
    planStatus: "Already plan",
    isOverdue: true,
  },
  {
    id: 203, lineId: "EE02",
    title: "F2607GHTT600M – AW26 / PARIS / DUP",
    style: "F2607GHTT600M", buy: "PARIS", category: "DUP",
    season: "AW26", orderQty: 6800, dutyQty: 3400, target: 310,
    productionDays: 11, conversionTime: "",
    inlineDate:      "2026-06-01",
    estOfflineDate:  "2026-06-16",
    finalOfflineDate:"2026-06-16",
    crd: "2026-07-05",
    planStatus: "Already plan",
    isHighlighted: true,
  },
  ...
  },
  {
    ...
    season: "AW26", orderQty: 5500, dutyQty: 2750, target: 350,
